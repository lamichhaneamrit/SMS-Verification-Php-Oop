...
if (isset($_POST['email'])) {
    ...
    $message = "{$user->firstName}, Your account has been created, Vist this link to verify your account : <a href='http://localhost/All_php_1/SMS-Verification-Php-Oop/verification/{$link}'>Verify Link</a>";
    $subject = "Account Verification";
    $verifyObj->sendToMail('amritsolta113@gmail.com', $message, $subject);
                ...
                <div class="sign-up-div">
                    <div class="name">
                        ...
                        <fieldset>
                            ...
                            <h4>An verification email has been sent to your email, check your email to verify your
                                account</h4>
                            <?php else : ?>
