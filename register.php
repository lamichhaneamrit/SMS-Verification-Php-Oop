                    ...
                    <form method="POST">
                        <div class="name">
                            ...
                            <input type="text" name="firstName" placeholder="First Name"
                                value="<?php echo ((isset($firstName)) ? Validate::escape($firstName) : ''); ?>" />
                            <input type="text" name="lastName" placeholder="Last Name"
                                value="<?php echo ((isset($lastName)) ? Validate::escape($lastName) : ''); ?>" />
                            <!-- Name Error -->
                        ...
                        <div>
                            ...
                            <input type="text" name="username" placeholder="Username"
                                value="<?php echo ((isset($username)) ? Validate::escape($username) : ''); ?>" />
                            <!-- Username Error -->
                        ...
                        <div>
                            ...
                            <input type="email" name="email" placeholder="Email"
                                value="<?php echo ((isset($email)) ? Validate::escape($email) : ''); ?>" />
                            <!-- Email Error -->
