...
if (!Validate::filterEmail($email)) {
            ...
            if (password_verify($password, $user->password)) {
                //update user
                $userObj->update('users', array('firstName' => $firstName, 'lastName' => $lastName, 'username' => $username, 'email' =>
                $email), array('user_id' => $user_id));
                    ...
                    <form method="POST">
                        <div class="name">
                            ...
                            <input type="text" name="firstName" placeholder="First Name"
                                value="<?php echo Validate::escape($user->firstName); ?>" />
                            <input type="text" name="lastName" placeholder="Last Name"
                                value="<?php echo Validate::escape($user->lastName); ?>" />
                        </div>
                        <!-- Name Error -->
                        ...
                        <div>
                            ...
                            <input type="text" name="username" placeholder="UserName"
                                value="<?php echo Validate::escape($user->username); ?>" />
                        </div>
                        <!-- Username Error -->
                        ...
                        <div>
                            ...
                            <input type="email" name="email" placeholder="Email"
                                value="<?php echo Validate::escape($user->email); ?>" />
                            <!-- Email Error -->
